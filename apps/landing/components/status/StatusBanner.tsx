      ...
      <div className="container">
        <div className="statusBannerLeft">
          ...
          <div>
            ...
            <p>
              NEAR Auth metrics on NEAR mainnet · Updated {relativeTime(data.generatedAt)} · auto-refresh{" "}
              {data.revalidateSeconds}s
            </p>
          </div>
        </div>
        <div className="statusBannerRight">
          <BannerStat label="NEAR Auth · 24h" value={fmtPct(data.summary.fastAuthSuccess24h, 0)} ok />
